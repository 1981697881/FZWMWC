<template>
	...
	<cu-custom bgColor="bg-gradual-blue" class="customHead" :isBack="true"><block slot="backText">返回</block><block slot="content">其他出库</block></cu-custom>
		<uni-fab
	    :pattern="pattern"
	...
	export default {
		...
		methods: {
			...
			initMain(){
				...
				console.log(123)
				basic.getBillNo({'TranType':29}).then(res => {
					console.log(res)
					if(res.success){
