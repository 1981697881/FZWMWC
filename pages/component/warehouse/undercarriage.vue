		...
		<view class="box getheight">
			...
			<view class="cu-bar bg-white solid-bottom" style="height: 60upx;">
				<view class="action" style="width: 100%;">
					...
					<input name="input" style="font-size: 13px;width: 100%; border-bottom:1px solid;margin-right: 10px;"
							...
							<view class="flex-sub">
								<view class="cu-form-group">
									...
									<input name="input" style="border-bottom: 1px solid;"
										v-model="popupForm.batchno"></input>
								</view>
							</view>
							<view class="flex-sub">
								<view class="cu-form-group">
		...
		<scroll-view scroll-y class="page" :style="{ 'height': pageHeight + 'px' }">
			...
			<view class="cu-bar tabbar shadow foot">
				<view class="box text-center">
					<button :disabled="isClick" class="cu-btn bg-blue shadow-blur lg"
						style="width: 48%;margin-right: 1%;" @tap="$manyCk(saveData)">提交</button>
					<button class="cu-btn bg-blue shadow-blur lg" style="width: 48%;margin-right: 1%;"
